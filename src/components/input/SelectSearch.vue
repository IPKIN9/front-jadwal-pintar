<template>
  <div class="input-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Cari Jurusan" v-model="searchPayload" @keyup="searchData()" @focus="searchData()">
  </div>
...
const emits = defineEmits(['searchEvent', 'update:modelValue'])
