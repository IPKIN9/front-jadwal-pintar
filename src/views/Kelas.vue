    ...
    <template v-slot:body>
      <div class="mx-2">
        ...
        <div class="form-group mb-3">
          <SelectSearch size="5" @search-event="getJurusanPayload" :list="jurusanList" :show-up="jurusanShow" v-model.number="payload.jurusan_id" />
          <small class="text-danger">
...
const getJurusanPayload = (jurusanPayload: any): void => {
  jurusan.getAll({
